...
//Config driver
/* Tizen uses open/close implementation */
...
struct mip_ts_info {
	...
	int x_info[MAX_FINGER_NUM];
	int y_info[MAX_FINGER_NUM];
	int m_info[MAX_FINGER_NUM];
