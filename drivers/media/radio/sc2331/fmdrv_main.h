...
#define FM_ENABLE_SUB_CMD       0x00
#define FM_TUNE_SUB_CMD         0x01
#define FM_MUTE_SUB_CMD         0x02
#define FM_SEARCH_SUB_CMD       0x03
#define FM_COMSEARCH_SUB_CMD    0x04
#define FM_ABORT_SUB_CMD        0x05
#define FM_SETRDSMODE_SUB_CMD   0x06
#define FM_SETRDSTYPE_SUB_CMD   0x07
#define FM_SETAUDIOMODE_SUB_CMD 0x08
#define FM_SETAUDIOPATH_SUB_CMD 0x09
#define FM_SETREGION_SUB_CMD    0x0A
#define FM_SETSCANSTEP_SUB_CMD  0x0B
#define FM_CONFIGdeemphasis_SUB_CMD   0x0C
#define FM_SETVOLUME_SUB_CMD    0x10
#define FM_DISABLE_SUB_CMD      0x12
#define FM_GET_RSSI_SUB_CMD     0x13
#define FM_SET_SOFTMUTE_CMD     0x15
#define FM_SET_Frequency_Offset_CMD   0x17
#define FM_SET_Pilot_Power_CMD   0x18
#define FM_SET_Noise_Power_CMD   0x19
#define FM_BLEND_SOFTMUTE_SUB_CMD 0x1A
...
/***********************************
add by wsh ,remove rd_wr byte
***********************************/
	struct fm_cmd_msg_hdr_sprd {
...
#define  FM_CMD_MSG_HDR_SIZE_SPRD  5
...
/*04 0e len 01 8C FC status data */
struct fm_cmd_complete_hdr_sprd {
    struct hci_ev_cmd_complete hci_cmd_complete;
    __u8 status;
    __u8 fm_opcode;        /* SPRD event data (after event status )*/
} __attribute__ ((packed));
#define FM_CMD_COMPLETE_HDR_SIZE_sprd     5 /* sizeof(struct fm_cmd_complete_hdr ) */
...
struct fm_cfg_soft_mute
{
	__u16      hbound;
	__u16      lbound;
}__attribute__((packed));

/* struct of control stereo/mono audio blend and soft mute parameters, */
struct fm_blend_soft_mute
{
	__u8   is_blend;
	struct fm_cfg_blend     blend;
	struct fm_cfg_soft_mute  soft_mute;
}__attribute__((packed));

struct new_data {
	__u8 subcmd;
	struct fm_blend_soft_mute b_user_cfg;
}__attribute__((packed));
...
#define FM_SCAN_DOWN 0x00
#define FM_SCAN_UP 0x01


#define brcm_FM_SCAN_DOWN 0x00 /* bit 7 = 0 : Scan towards lower frequency */
#define brcm_FM_SCAN_UP 0x80 /* bit 7 = 1 : Scan towards upper frequency */
...
/* Frequency_Offset threshold min and max */
#define FM_RX_Frequency_Offset_THRESHOLD_MIN    0
#define FM_RX_Frequency_Offset_THRESHOLD_MAX    0xFFFF /*0x1000 for norminal*/

/* Noise_Powert threshold min and max */
#define FM_RX_Noise_Power_THRESHOLD_MIN    0
#define FM_RX_Noise_Power_THRESHOLD_MAX    0x1FFF /*0x200 for norminal*/

/* Pilot_Power threshold min and max */
#define FM_RX_Pilot_Power_THRESHOLD_MIN    0
#define FM_RX_Pilot_Power_THRESHOLD_MAX    0x1FFF /*0x300 for norminal*/


/* RSSI threshold min and max */
#define FM_RX_RSSI_THRESHOLD_MIN    0   /* 0 dBuV */
#define FM_RX_RSSI_THRESHOLD_MAX    0x1FF /*127*/ /* 191.1477 dBuV */
