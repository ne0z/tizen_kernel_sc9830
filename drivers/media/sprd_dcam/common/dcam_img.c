...
#if defined(CONFIG_MACH_J3XLTE) || defined(CONFIG_MACH_J3XNLTE) || defined(CONFIG_MACH_J3X3G) || defined(CONFIG_MACH_J1ACEVELTE) || defined(CONFIG_MACH_J1MINILTE) || defined(CONFIG_MACH_Z2_LTE) || defined(CONFIG_MACH_GTEXSLTE)
